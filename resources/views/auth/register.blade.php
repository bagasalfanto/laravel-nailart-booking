        ...
        <div class="mx-auto w-full max-w-2xl rounded-2xl border border-white/80 bg-white/95 px-6 py-7 shadow-[0_18px_50px_rgba(205,163,173,0.18)] sm:px-10 sm:py-10">
            <form method="POST" action="{{ route('register') }}" class="space-y-5 text-left">
                ...
                <div class="space-y-2">
                    ...
                    <input id="email" type="email" name="email" value="{{ old('email') }}" required autocomplete="email" placeholder="hello@example.com" class="block w-full rounded-md border border-[#efd1d6] bg-[#fdf7f8] px-4 py-3 text-sm text-[#3a3133] outline-none transition placeholder:text-[#c9bcc0] focus:border-[#e4a9ba] focus:ring-2 focus:ring-[#f0c5d3]/70" />
                ...
                <div class="space-y-2">
                    ...
                    <input id="full_name" type="text" name="full_name" value="{{ old('full_name') }}" required autofocus autocomplete="name" placeholder="John Doe" class="block w-full rounded-md border border-[#efd1d6] bg-[#fdf7f8] px-4 py-3 text-sm text-[#3a3133] outline-none transition placeholder:text-[#c9bcc0] focus:border-[#e4a9ba] focus:ring-2 focus:ring-[#f0c5d3]/70" />
                    <x-input-error :messages="$errors->get('full_name')" />
                </div>

                <div class="space-y-2">
                    <label for="phone_number" class="block text-lg font-medium text-[#221d1f]" style="font-family: 'Cormorant Garamond', serif;">Phone Number</label>
                    <input id="phone_number" type="text" name="phone_number" value="{{ old('phone_number') }}" autocomplete="tel" placeholder="+62 888 888 8888" class="block w-full rounded-md border border-[#efd1d6] bg-[#fdf7f8] px-4 py-3 text-sm text-[#3a3133] outline-none transition placeholder:text-[#c9bcc0] focus:border-[#e4a9ba] focus:ring-2 focus:ring-[#f0c5d3]/70" />
                ...
                <div class="space-y-2">
                    ...
                    <input id="password" type="password" name="password" required autocomplete="new-password" placeholder="********" class="block w-full rounded-md border border-[#efd1d6] bg-[#fdf7f8] px-4 py-3 text-sm text-[#3a3133] outline-none transition placeholder:text-[#c9bcc0] focus:border-[#e4a9ba] focus:ring-2 focus:ring-[#f0c5d3]/70" />
